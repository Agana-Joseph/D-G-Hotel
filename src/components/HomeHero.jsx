      ...
      <div className="absolute z-5 w-full h-full bg-black/40">
        <div className="max-w-5xl mx-auto px-5 pt-20 lg:pt-28 flex flex-col justify-center h-full lg:flex-row lg:items-center gap-10">
          <div className="lg:w-7/12 flex flex-col gap-4">
            ...
            <div className="text-left text-3xl lg:text-5xl font-btnFont text-white font-normal">Welcome to  <br /> 5 Star Hotel</div>
            <div className="text-left text-md w-11/12 text-white font-normal  hidden lg:block">Himply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard</div>
          </div>
          <div className="max-w-lg mx-auto lg:w-5/12 bg-bgWhite p-5 flex flex-col gap-6 lg:gap-8">
            <div>
              <label htmlFor="" className="text-primaryDarker flex flex-col gap-2 text-left font-normal w-full">
                Check-in
            ...
            <div className="grid grid-cols-2 gap-4 w-full">
              <div>
                <label htmlFor="" className="text-primaryDarker flex flex-col gap-2 text-left font-normal">
                  Adults
